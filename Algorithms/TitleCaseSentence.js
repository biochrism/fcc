...
function titleCase(str){
    ...
    for(var i=0; i<strarray.length; i++){
        ...
        var singlechar = strarray[i].split("");
        for(var y=0; y<singlechar.length; y++){
           if(y==0){
                finalstring += singlechar[y].toUpperCase();
           }else{
               finalstring += singlechar[y].toLowerCase();
           }
       }//for each char
       finalstring += " ";
...
//with a map and replace quick version ////////////////////////////////////////////////////////////////////////////////////////////////////
function titleCase(str) { 
   return str.toLowerCase().split(' ').map(function(word) { 
     return word.replace(word[0], word[0].toUpperCase()); 
   }).join(' '); 
